...
function Show-MonoMenu {
   ...
   [3] HP 4103
   [4] HP 428
   [5] Samsung 4020/4070/4080
   [6] Canon 527
   [7] Canon 6030
   [8] Canon 1643_IF_v1
   [9] Canon 1643_IF_v2
   [10] Canon 1643_MF_X_v2
   [11] Xerox 3020
   [12] Xerox 205
   [13] Xerox 210
   [14] Xerox 3335
...
"@
    ...
    switch ($op) {
        ...
        "3"  { Install-HP4103 }
        "4"  { Invoke-Baixar "HP_428" "https://ftp.hp.com/pub/softlib/software13/printers/LJ/M428-M429/V4_DriveronlyWebpack-48.6.4638-LJM428-M429_V4_DriveronlyWebpack.exe" "HP_428.exe" "https://ftp.hp.com/pub/softlib/software13/printers/SJ0001/MFPs/Full_Webpack-63.6.6364-SJ0001_Full_Webpack.exe" "HP_SJ0001.exe" }
        "5"  { Invoke-Baixar "Samsung" "https://ftp.hp.com/pub/softlib/software13/printers/SS/SL-M3370FD/SamsungUniversalPrintDriver3_V3.00.16.0101.01.exe" "SamsungDriver.exe" "https://ftp.hp.com/pub/softlib/software13/printers/SS/Common_SW/WIN_EPM_V2.00.01.36.exe" "WIN_EPM_V2.00.01.36.exe" "https://ftp.hp.com/pub/softlib/software13/printers/SS/SL-M5270LX/WIN_EDC_V2.02.61.exe" "SamsungEPM.exe" }
        "6"  { Invoke-BaixarEAbrir "Canon_527" "https://gdlp01.c-wss.com/gds/0/0100012920/01/GPlus_PCL6_Driver_V340_32_64_00.exe" "Canon.exe" "https://github.com/cyanfish/naps2/releases/download/v8.2.1/naps2-8.2.1-win-x64.exe" "naps2.exe" }
        "7"  { Invoke-BaixarEAbrir "Canon_6030" "https://gdlp01.c-wss.com/gds/2/0100010942/01/LBP6030_V2111_WP_PT.exe" "Canon.exe" }
        "8"  { Invoke-Baixar "Canon_1643_v1" "https://gdlp01.c-wss.com/gds/0/0100010410/03/iR1643MFDriverv6502W64.exe" "Canon_1643_v1.exe" "https://gdlp01.c-wss.com/gds/8/0200006868/03/winmfscanutilityv12102.exe" "Canon_Utility.exe" }
        "9"  { Invoke-Baixar "Canon_1643_v2" "https://gdlp01.c-wss.com/gds/8/0100011188/01/iR1643iIIMFDriverV720W64.exe" "Canon_1643_v2.exe" "https://gdlp01.c-wss.com/gds/8/0200006868/03/winmfscanutilityv12102.exe" "Canon_Utility.exe" }
        "10" { Invoke-Baixar "Canon_1643_X_v2" "https://gdlp01.c-wss.com/gds/7/0100011197/01/MF1643iIIMFDriverV720W64.exe" "Canon_1643_X_v2.exe" "https://gdlp01.c-wss.com/gds/8/0200006868/03/winmfscanutilityv12102.exe" "Canon_Utility.exe" }
...
"@
    ...
    switch ($op) {
        ...
        "2"  { Invoke-Baixar "Epson L3150" "https://ftp.epson.com/latin/drivers/inkjet/L3150_Lite_LA.exe" "L3150.exe" }
        "3"  { Invoke-Baixar "Epson L3250" "https://ftp.epson.com/latin/drivers/inkjet/L3250_L3251_Lite_LA.exe" "L3250.exe" }
        "4"  { Invoke-Baixar "Epson L5590" "https://ftp.epson.com/latin/drivers/inkjet/L5590_X64_380_LA.exe" "L5590.exe" "https://ftp.epson.com/latin/drivers/inkjet/L5590_EScan2_67810_LA.exe" "L5590_Full.exe" }
        "5"  { Invoke-Baixar "Epson L6190" "https://ftp.epson.com/latin/drivers/inkjet/L6191_X64_2120_LA.exe" "L6190.exe" "https://ftp.epson.com/latin/drivers/inkjet/L6191_EScan2_65230_LA.exe" "L6190_Full.exe" }
        "6"  { Invoke-Baixar "Epson L6270" "https://ftp.epson.com/latin/drivers/inkjet/L6270_X64_38000_2_LA.exe" "L6270.exe" "https://ftp.epson.com/latin/drivers/inkjet/L6270_EScan2_67810_LA.exe" "L6270_Full.exe" }
        ...
        "8"  { Invoke-Baixar "Epson L805" "https://ftp.epson.com/latin/drivers/Impresoras/L805/L805_Win_Lite_1.0APS_FD.exe" "L805.exe" }
        "9"  { Invoke-Baixar "Epson L655" "https://ftp.epson.com/latin/drivers/inkjet/L655_L656_X64_260_LA.exe" "L656.exe" "https://ftp.epson.com/latin/drivers/Multi/l655/L655_L656_scan_4020_FD.exe" "Scan.exe" }
        "10" { Invoke-Baixar "Epson WF 3720" "https://ftp.epson.com/drivers/WF3720_X64_2100_NA.exe" "3720.exe" "https://ftp.epson.com/drivers/epson18528.exe" "Scan.exe" }
        "11" { Invoke-Baixar "Epson WF 5899" "https://ftp.epson.com/drivers/WFM5899_PCL6_X64_210000_AM.exe" "5899.exe" "https://ftp.epson.com/drivers/WFM5899_EScan2_67810_AM.exe" "Scan.exe" }
        "12" { Invoke-Baixar "Epson WF 5710" "https://ftp.epson.com/drivers/WFC5710_X64_2120_AM.exe" "5710.exe" "https://ftp.epson.com/drivers/WFC5710_C5790_EScan2_65310_AM.exe" "Scan.exe" }
        "13" { Invoke-Baixar "Epson WF 5790" "https://ftp.epson.com/drivers/WFC5790_STD_X64_2120_AM.exe" "5790.exe" "https://ftp.epson.com/drivers/WFC5710_C5790_EScan2_65310_AM.exe" "Scan.exe" }
        "14" { Invoke-Baixar "Epson WF 5810" "https://ftp.epson.com/latin/drivers/inkjet/WFC5810_STD_X64_380_LA.exe" "5810.exe" "https://ftp.epson.com/drivers/WFC5810_C5890_EScan2_67810_AM.exe" "Scan.exe" }
        "15" { Invoke-Baixar "Epson M1180" "https://ftp.epson.com/latin/drivers/inkjet/M1180_Lite_LA.exe" "M1180.exe" }
        "16" { Invoke-Baixar "Epson M3180" "https://download.epson-europe.com/pub/download/6771/epson677145eu.exe?ot_preferences=C0004%3A0%2CC0003%3A0%2CC0002%3A0%2CC0001%3A1&adobe_mc=ad8cb437-bcd3-458a-b124-678dc7b661ea" "M3180.exe" "https://download.epson-europe.com/pub/download/6769/epson676922eu.exe?ot_preferences=C0004%3A0%2CC0003%3A0%2CC0002%3A0%2CC0001%3A1&adobe_mc=ad8cb437-bcd3-458a-b124-678dc7b661ea" "Scan.exe" }
        "0"  { Show-MainMenu }
    ...
    switch ($op) {
        ...
        "3" {
            Invoke-BaixarEAbrir "HPRT" `
                "https://static.hprt.com/hprt/file/20250701/HPRT+POS+Printer+Driver+v2.7.4.10.zip?e=1778108143&token=IAM-9k7ObqNwa2J4Nzcvl1tLlPo7Rq4hOiyFzGqzZfWp:5pqtYZJ52BL9Gl77ryETxacsAJU=" "HPRT.zip" `
                "https://static.hprt.com/hprt/file/20250617/HPRTUtilityForPOSSetup+V1.2.4.19.zip?e=1778108158&token=IAM-9k7ObqNwa2J4Nzcvl1tLlPo7Rq4hOiyFzGqzZfWp:pESjYfjRvtslOdd0wtx7NFCNsFE=" "HPRT_utili.zip"
        }
        "4" {
            Invoke-BaixarEAbrir "HPRT_Ares" `
                "https://static.hprt.com/hprt/file/20250429/HPRT_Label_Derivative_Printer_Windows_Driver_v2.7.2.2.zip?e=1778108007&token=IAM-9k7ObqNwa2J4Nzcvl1tLlPo7Rq4hOiyFzGqzZfWp:iCsvXlpWxDdzvfU8cIQnssfOhHk=" "HPRTAres_driver.zip" `
                "https://static.hprt.com/hprt/file/20250427/HPRT-Label-Designer-BT2016_R6_3141_UL.zip?e=1778108076&token=IAM-9k7ObqNwa2J4Nzcvl1tLlPo7Rq4hOiyFzGqzZfWp:zdNpb2Y6IpjD-PJaZDa0PuosV0k=" "HPRTAres_designer.zip" `
                "https://static.hprt.com/hprt/file/20250429/HPRTPrinterUtility-V1.0.0.16.Test01.zip?e=1778108088&token=IAM-9k7ObqNwa2J4Nzcvl1tLlPo7Rq4hOiyFzGqzZfWp:TYkdrsG6Le3lLkb3CL-hC5aurQ4=" "HPRTAres_utility.zip"
        }
        "0"  { Show-MainMenu }
