...
if "%opcao_mono%"=="11" call :BAIXAR "Xerox_3020" "https://download.support.xerox.com/pub/drivers/3₀₂₀/drivers/win₁₀/ar/Xerox_Phaser_3020_Windows_Print_Drivers_Utilities_V1.07.exe" "Xerox_3020.exe"
if "%opcao_mono%"=="12" call :BAIXAR "Xerox_205" "https://download.support.xerox.com/pub/drivers/B₂₀₅/drivers/win₁₀/ar/Xerox_B205_Windows_Print_Drivers_Utilities_V1.12.exe" "Xerox_205.exe"
if "%opcao_mono%"=="13" call :BAIXAR "Xerox_210" "https://download.support.xerox.com/pub/drivers/B₂₁₀/drivers/win₁₀/ar/Xerox_B210_Windows_Print_Drivers_Utilities_V1.12.exe" "Xerox_210.exe"
