...
if "%opcao_mono%"=="10" call :BAIXAR "Canon_1643_X_v2" "https://gdlp01.c-wss.com/gds/7/0100011197/01/MF1643iIIMFDriverV720W64.exe" "Canon_1643_X_v2.exe" "https://gdlp01.c-wss.com/gds/8/0200006868/03/winmfscanutilityv12102.exe" "Canon_Utility.exe" 
if "%opcao_mono%"=="11" call :BAIXAR "Xerox_3020" "https://download.support.xerox.com/pub/drivers/3020/drivers/win10/ar/Xerox_Phaser_3020_Windows_Print_Drivers_Utilities_V1.07.exe" "Xerox_3020.exe"
if "%opcao_mono%"=="12" call :BAIXAR "Xerox_205" "https://download.support.xerox.com/pub/drivers/B205/drivers/win10/ar/Xerox_B205_Windows_Print_Drivers_Utilities_V1.12.exe" "Xerox_205.exe"
if "%opcao_mono%"=="13" call :BAIXAR "Xerox_210" "https://download.support.xerox.com/pub/drivers/B210/drivers/win10/ar/Xerox_B210_Windows_Print_Drivers_Utilities_V1.12.exe" "Xerox_210.exe"
...
if "%opcao_mono%"=="1" call :BAIXAR_E_ABRIR "Canon "https://gdlp01.c-wss.com/gds/9/0100009799/05/DR-C240_Driver_V.1.4.11712.18001SP4_Windows.zip" "Driver.zip" "https://gdlp01.c-wss.com/gds/0/0200006680/07/CaptureOnTouch_Pro_V5.5.1025.1217.zip" "CaptureOnTouch.zip"
